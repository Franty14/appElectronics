...
namespace UTN.Winform.Electronics.Layers.UI.Procesos
{
    ...
    /*
     Tareas 
     1- Rebajar del inventario 
     2- En buscar producto por codigo mismo comportamiento de busqueda que por cliente.
     3- Borrar un producto del DataGridView  por medio de un MenuContext
    ...
    */
    public partial class frmFacturacion : Form
    {
        ...
        private void tspBarraSuperior_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
